...
QT_MOC_LITERAL(1, 10, 16), // "uavMarkerClicked"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5) // "uavId"

    },
    "MapWidget\0uavMarkerClicked\0\0uavId"
};
...
void MapWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->uavMarkerClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MapWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapWidget::uavMarkerClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MapWidget::uavMarkerClicked(int _t1)
{
